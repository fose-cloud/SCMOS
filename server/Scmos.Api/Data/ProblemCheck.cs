...
public static class ProblemCheck
{
    ...
    [
        ...
        ("Evonik Tank stays off the delay list through 180 minutes",
            Job("J2", arrTime: "11:00", customer: "EVONIK", type: "1X20' TK"), Nothing, null),
        ("Evonik Tank enters the delay list after 180 minutes",
            Job("J3", arrTime: "11:01", customer: "EVONIK", type: "1X20' TK"), Nothing, ProblemRules.Problem.ArrivedLate),
