...
export function SCMOSApp({ initialUser, signOutHref, demo }: Props) {
    ...
    (async () => {
      ...
      queries.forEach((query, index) => {
        ...
        cached[wanted[index]] = {
          ...
          truckers: saved.truckers,
          assignees: saved.assignees,
          types: saved.types,
          years: saved.years,
          months: saved.months,
          periodDates: saved.periodDates,
          periodDateCounts: saved.periodDateCounts,
        };
      });
      ...
      wanted.forEach((cat, index) => {
        ...
        next[cat] = {
          ...
          periodDates: answer.periodDates,
          periodDateCounts: answer.periodDateCounts,
        };
      });
      setServerPages(next);
    })();
  ...
  function insertRow() {
    ...
    const job: Job = {
      ...
      ot: "", pickupPlan: "", pickupTime: "", lorealPickupContainer: "",
  ...
  function saveAddJob() {
    ...
    const job: Job = {
      ...
      closingDate: "", closingTime: "", reason: "", remark: "", ot: "", pickupPlan: "", pickupTime: "",
      lorealPickupContainer: "", cs: "",
