...
export const META: Record<string, [string, string, string]> = {
  ...
  chemours: ["The Chemours", "งานกระจายสินค้า ค่าขนส่ง และใบรับ-ส่งสินค้า", "แก้ไขงาน Domestic ได้ในตาราง · การ์ดราคาของลูกค้ารายนี้เก็บแยกจากตารางราคาผู้รับเหมา อ่านราคาตามราคาน้ำมันดีเซลที่กรอก เปิดไฟล์ราคาขายเพิ่มแล้วจะเห็นทุน/ขาย/กำไรในแถวเดียวกัน · ใบรับ-ส่งสินค้าเลือกงาน Domestic แล้วกรอกให้เอง เหลือเวลารถเข้า-ออกให้กรอกหน้างาน"],
