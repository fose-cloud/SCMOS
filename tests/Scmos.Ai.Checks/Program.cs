...
Check(agents.All.Count == 9 && agents.Resolve(request)?.Id == operations.Id, "nine specialists (the Communication Agent since Phase 4) and deterministic master default");
