...
Check(agents.All.Count == 11 && agents.Resolve(request)?.Id == operations.Id, "eleven specialists (Engineering Agent since Phase 6, SRE Agent since Phase 7) and deterministic master default");
...
await EngineeringChecks.RunAsync(Check);
